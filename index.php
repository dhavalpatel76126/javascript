...
<script type="text/javascript">
	...
	{
		window.location.href='index.php?page='+pages+'&limit='+limit+'&sortBy='+sortb+'&sortType='+sorttpe+'&search='+searchpage+'';
	}
	...
	function myOnLoadFunction() {
		...
		//pagination href link
		var myPagination = document.getElementById("hrefPagination");
		for(var pagen=1;pagen<=totalPages;pagen++){
	 //   var pageno = myPagination.insertAdjacentHTML("beforeend","<li id='page"+pagen+"'>"+pagen+"</li>");
		var pageno = myPagination.appendChild(document.createElement("li"));
		pageno.id=pagen;
		pageno.value=pagen;
		console.log("this is page number " +pageno+" "+pagen);
...
for ($i = 1; $i <= $total_pages; $i++) {
    ?>
    <li><a href="#" onclick="onPageClick(<?=$i?>)"><?=$i?></a></li>
<?php
